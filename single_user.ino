...
void loop() {
      ...
      delay(5000);
      mysim.println("ATD+8801792170982;"); //  change ZZ with country code and xxxxxxxxxxx with phone number to dial
      updateSerial();
...
void sendSMS(String message)
{
  ...
  mysim.println("AT + CMGS = \"+8801792170982\"");  // recipient's mobile number, in international format
  updateSerial();
  delay(1000);
